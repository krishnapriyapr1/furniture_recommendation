    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommendations_count', models.IntegerField(blank=True, default=0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='handwash.category')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='handwash.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='handwash.product')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
